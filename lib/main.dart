...
class Samples extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: const Text('Samples',style: TextStyle(fontSize: 15),),
        ),
        body: Center(
          child: Column(
...
class _SamplesAtRestState extends State<SamplesAtRest> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('At rest Samples',style: TextStyle(fontSize: 15),),
      ),
      body: Column(
        children: [
          Expanded(
...
class _SamplesTextState extends State<SamplesText> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Text Samples',style: TextStyle(fontSize: 15),),
      ),
      body: Column(
        children: [
          Expanded(
...
class _TextSequenceState extends State<_TextSequence> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Text sequence',style: TextStyle(fontSize: 15),),
      ),
      body: Column(
        children: const [
          Expanded(
